...
def test_tool_result_carries_contract_version():
    ...
    the only channel live after connect (and compares it to the version in its installed
    HIVEMIND-RULES marker). Covers success, abstain, capture, and the recorded paths."""
    server, _ = build_real_server()
