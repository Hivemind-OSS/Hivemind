...
run's job (real Qwen3 + Claude extraction), not this smoke's. (The poison runner's own offline
end-to-end lives in test_poison_run — this module smokes the retrieval runner.)"""
