...
def test_no_red_or_green_health_state_anywhere():
    ...
    for token in ("#ff0000", "#f00 ", "#00ff00", "#0f0 ", "rgb(255,0,0)", "rgb(0,128,0)",
                  "tomato", "crimson", "seagreen", "limegreen", "indianred", "forestgreen"):
...
def test_typography_system():
    ...
    assert "letter-spacing" in LOW and "uppercase" in LOW  # wide-tracked uppercase eyebrows
