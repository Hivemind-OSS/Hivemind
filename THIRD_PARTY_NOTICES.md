...
- **Modifications:** none. The model is used unmodified; at inference its embeddings are
  Matryoshka-truncated to 768 dimensions and L2-normalized — no model weights are modified.
