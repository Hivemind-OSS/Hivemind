...
TOOL_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "last_error}. Each last_error states its scope's MOST RECENT completed "
        "tick: re-stamped while the fault persists, cleared to null by that "
        "scope's next clean tick — non-null means failing NOW (a fleet "
        "last_error is the daemon itself, and while it stands every repo block "
        "is a stale snapshot). "
