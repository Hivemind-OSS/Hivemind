...
SERVER_INSTRUCTIONS = (
    ...
    "a memory.\n"
    "• CAPTURE durable insight with hive_capture(text=...) — no need to ask; it lands quarantined "
    "and is served only once other seats independently need it.\n"
    "• WRITE only with a human's in-chat yes: hive_write(text=..., approved_by=\"<user>\"); correct "
    "an existing memory with hive_write(replaces=<episode_id>).\n\n"
    + CAPTURE_TAXONOMY + "\n\n"
