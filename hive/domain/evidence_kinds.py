...
EK_CHANGE_OUTCOME: str = (
    "change_outcome"  # SHA-bound census change outcome (censusctl ingest)
)
EK_OUTCOME_VERIFIED_HELPED: str = (
    "outcome_verified_helped"  # SHA-bound corroboration (census ingest)
)
