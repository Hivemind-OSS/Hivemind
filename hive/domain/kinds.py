...
QUERY_GUIDANCE = (
    ...
    "similarities and the gate ABSTAINS rather than guess. One intent per query (a bundled "
    "multi-question query dilutes toward the centroid -> abstain). Phrase as the claim you "
