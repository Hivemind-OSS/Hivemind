"""Bespoke Rust extractor, not config-driven."""
...
from .generic import _rust_collect_type_refs
from .support import _LANGUAGE_BUILTIN_GLOBALS, _file_stem, _make_id, _read_text
...
def extract_rust(path: Path) -> dict[str, Any]:
    ...
    def emit_param_return_refs(func_node: Node, func_nid: str, line: int) -> None:
    ...
    def walk(node: Node, parent_impl_nid: str | None = None) -> None:
        t = node.type
